...
namespace UnityEngine.UI.Extensions
{
	...
	[AddComponentMenu("UI/Extensions/UI SweatyChair Scrollrect Occlusion")]
		...
		public void Init()
		{
			if (GetComponent<ScrollRect>() != null) {
				...
				for (int i = 0; i < _scrollRect.content.childCount; i++) {
					RectTransform rectTF = _scrollRect.content.GetChild(i).GetComponent<RectTransform>();
					items.Add(rectTF);
				}
				ResetComponents();
			} else {
