...
namespace UnityEngine.UI
{
	...
	/// <summary>
	/// Extension class for Scrollbar to allow for setting values from code without calling the set event
	/// </summary>
	[RequireComponent(typeof(RectTransform))]
	public class ScrollbarExt : Selectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
		...
		protected ScrollbarExt() { }

		// Scroll bar's current value in 0 to 1 range.
		[Range(0f, 1f)]
		[SerializeField]
		protected float m_Value;
		public float rawValue => m_Value;
		...
		[Range(0, 51)]
		[SerializeField]
		protected int m_NumberOfSteps = 0;
		...
		[SerializeField] private bool m_addKnobComponent = true;
		...
		void UpdateCachedReferences()
		{
			...
			if (m_HandleRect != null && m_addKnobComponent) {
				ScrollbarExtKnob extKnob = m_HandleRect.GetOrAddComponent<ScrollbarExtKnob>();
				extKnob.parentScrollbar = this;
			}
		}
